...
RSpec.describe Team, type: :model do
  ...
  # ------------------------------------------------------------------------
  let(:assignment_team) { AssignmentTeam.create!(parent_id: assignment.id, name: "Team A", max_team_size: 3) }
  let(:course_team)     { CourseTeam.create!(parent_id: course.id, name: "Team B", max_team_size: 5) }
  ...
  describe 'associations' do
    ...
    it { should have_many(:signed_up_teams).dependent(:destroy) }
  ...
  describe 'team management' do
    ...
    let(:team) { CourseTeam.create!(parent_id: course.id, name: "Test Team", max_team_size: 1) }
